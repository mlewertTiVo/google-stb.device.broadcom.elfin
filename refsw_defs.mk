...
export LINUX_OUT_1ST_ARCH := $(LINUX_OUT)
...
B_REFSW_OBJ_ROOT_1ST_ARCH := ${B_REFSW_OBJ_ROOT}
...
NEXUS_BIN_DIR_1ST_ARCH   := $(NEXUS_BIN_DIR)
B_REFSW_ANDROID_LIB := ${BRCMSTB_ANDROID_OUT_PATH}/target/product/${ANDROID_PRODUCT_OUT}/obj/lib
export NEXUS_TOP ROCKFORD_TOP BSEAV_TOP B_REFSW_OBJ_ROOT B_REFSW_OBJ_ROOT_1ST_ARCH NEXUS_BIN_DIR NEXUS_BIN_DIR_1ST_ARCH B_BOLT_OBJ_ROOT B_DHD_OBJ_ROOT B_REFSW_TOOLCHAINS_INSTALL B_REFSW_ANDROID_LIB
